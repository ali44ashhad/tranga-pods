  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          <motion.h2 variants={itemVariants} className="text-4xl md:text-5xl font-light mb-6 text-[#14132C]">
            Learn About Tranga Pods
          </motion.h2>
          <motion.p variants={itemVariants} className="text-lg text-[#14132C]/80 max-w-2xl mx-auto">
        ...
        >
          {features.map((feature, index) => (
            ...
            >
              <div className="w-12 h-12 rounded-full bg-[#FF9178]/20 flex items-center justify-center mb-4">
                <div className="text-[#FF9178]">
                  {feature.icon}
                </div>
              </div>
